...
const printGlobalSettings = () => {
    ...
    printSubSectionSeparator();
    console.log(SPACE, GLOBAL_CONFIG.BET_CONFIGURATION.MARTINGALE_CONFIG.ANTI_MARTINGALE ? CONSOLE_STRINGS.TEMPLATES.GLOBAL_SETTINGS.ANTI_MARTINGALE : CONSOLE_STRINGS.TEMPLATES.GLOBAL_SETTINGS.MARTINGALE, GLOBAL_CONFIG.BET_CONFIGURATION.MARTINGALE_CONFIG.ACTIVE ? CONSOLE_STRINGS.YES : CONSOLE_STRINGS.NO);
    if (GLOBAL_CONFIG.BET_CONFIGURATION.MARTINGALE_CONFIG.ACTIVE) {
        console.log(SPACE, CONSOLE_STRINGS.TEMPLATES.GLOBAL_SETTINGS.INCREMENT_BET_AMOUNT, GLOBAL_CONFIG.BET_CONFIGURATION.MARTINGALE_CONFIG.INCREMENT_BET_AMOUNT + "x");
    }
    ...
    console.log(SPACE, CONSOLE_STRINGS.TEMPLATES.GLOBAL_SETTINGS.REGISTER_USERS, GLOBAL_CONFIG.ANALYTICS_CONFIGURATION.REGISTER_USERS_ACTIVITY ? CONSOLE_STRINGS.YES : CONSOLE_STRINGS.NO);
    console.log(SPACE, CONSOLE_STRINGS.TEMPLATES.GLOBAL_SETTINGS.REGISTER_ROUNDS, GLOBAL_CONFIG.ANALYTICS_CONFIGURATION.REGISTER_ALL_ROUNDS_DATA ? CONSOLE_STRINGS.YES : CONSOLE_STRINGS.NO);
    console.log(SPACE, CONSOLE_STRINGS.TEMPLATES.GLOBAL_SETTINGS.RESET_HISTORY_BACKUP, GLOBAL_CONFIG.ANALYTICS_CONFIGURATION.RESET_AND_BACKUP_BOT_HISTORY ? CONSOLE_STRINGS.YES : CONSOLE_STRINGS.NO);
...
const printStartRoundEvent = (startRoundEvent, pendingRounds) => {
    ...
    if (startRoundEvent.errors.length) {
        ...
        console.log(SPACE, evalString(CONSOLE_STRINGS.INFO_MESSAGE.WAITING_STRATEGY_MESSAGE, { minutes: ((GLOBAL_CONFIG.STRATEGY_CONFIGURATION.WAITING_TIME - START_ROUND_WAITING_TIME) / 60000).toFixed(1), strategy: GLOBAL_CONFIG.STRATEGY_CONFIGURATION.SELECTED_STRATEGY }));
    }
    printSectionSeparator();
...
const printBetRoundEvent = (betRoundEvent) => {
    ...
    if (betRoundEvent.skipRound) {
        ...
        if (betRoundEvent.pricemessage) {
            console.log(SPACE, betRoundEvent.pricemessage);
        }
